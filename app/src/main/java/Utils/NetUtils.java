...
//    }
    ...
    public static void openSetting(final Activity activity) {
        ...
        View vv = inflater.inflate(R.layout.wanglufuwu, null);
        TextView quexiao= (TextView) vv.findViewById(R.id.quexiao);
        TextView queding= (TextView) vv.findViewById(R.id.queding);
