...
public class SPUtils {
    ...
    public void setShared(String key, String value, Context ctx){
        SharedPreferences shared=ctx.getSharedPreferences(name2,0);
        SharedPreferences.Editor edit = shared.edit();
    ...
    public String getShared2(Context ctx, String key){
        SharedPreferences shared = ctx.getSharedPreferences(name2, 0);
        String aLong = shared.getString(key, "");
        return aLong;
    }
}
